import type {
    ...
    CarrierOpsSummary,
} from '../../../../src/generated/server/ivee/aviation/v1/service_server';
    ...
    try {
        const result = await cachedFetchJson<{ carriers: CarrierOpsSummary[] }>(
            cacheKey, CACHE_TTL, async () => {
                ...
                type FI = import('../../../../src/generated/server/ivee/aviation/v1/service_server').FlightInstance;
                const allFlights: FI[] = [];
                ...
                const groups = new Map<string, {
                    carrier: import('../../../../src/generated/server/ivee/aviation/v1/service_server').Carrier;
                    airport: string;
                    flights: FI[];
                }>();
