...
1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/koala73/ivee/security/advisories/new) to submit your report directly through the repository.
