...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.ivee.app': 'tech',
  'finance.ivee.app': 'finance',
  'commodity.ivee.app': 'commodity',
  'happy.ivee.app': 'happy',
};
...
const VARIANT_OG: Record<string, { title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    image: 'https://tech.ivee.app/favico/tech/og-image.png',
    url: 'https://tech.ivee.app/',
  },
  finance: {
    title: 'Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://finance.ivee.app/favico/finance/og-image.png',
    url: 'https://finance.ivee.app/',
  },
  commodity: {
    ...
    image: 'https://commodity.ivee.app/favico/commodity/og-image.png',
    url: 'https://commodity.ivee.app/',
  },
  happy: {
    ...
    image: 'https://happy.ivee.app/favico/happy/og-image.png',
    url: 'https://happy.ivee.app/',
  },
};
