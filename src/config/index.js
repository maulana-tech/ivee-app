...
// VITE_VARIANT=tech → tech.ivee.app (tech-focused)
// VITE_VARIANT=full → ivee.app (geopolitical)
// VITE_VARIANT=finance → finance.ivee.app (markets/trading)
export { SITE_VARIANT } from './variant';
// Shared base configuration (always included)
export { IDLE_PAUSE_MS, REFRESH_INTERVALS, MONITOR_COLORS, STORAGE_KEYS, } from './variants/base';
// Market data (shared)
...
export { SOURCE_TIERS, getSourceTier, SOURCE_TYPES, getSourceType, getSourcePropagandaRisk, ALERT_KEYWORDS, ALERT_EXCLUSIONS, } from './feeds';
// Panel configuration - imported from panels.ts
export { DEFAULT_PANELS, DEFAULT_MAP_LAYERS, MOBILE_DEFAULT_MAP_LAYERS, LAYER_TO_SOURCE, ALL_PANELS, VARIANT_DEFAULTS, VARIANT_PANEL_OVERRIDES, getEffectivePanelConfig, isPanelEntitled, FREE_MAX_PANELS, FREE_MAX_SOURCES, } from './panels';
// ============================================
...
export { INTEL_HOTSPOTS, CONFLICT_ZONES, MILITARY_BASES, NUCLEAR_FACILITIES, STRATEGIC_WATERWAYS, ECONOMIC_CENTERS, SANCTIONED_COUNTRIES, SANCTIONED_COUNTRIES_ALPHA2, SPACEPORTS, CRITICAL_MINERALS, } from './geo';
...
export { ENTITY_REGISTRY, getEntityById, } from './entities';
...
export { AI_REGULATIONS, REGULATORY_ACTIONS, COUNTRY_REGULATION_PROFILES, getUpcomingDeadlines, getRecentActions, } from './ai-regulations';
export { STARTUP_HUBS, ACCELERATORS, TECH_HQS, CLOUD_REGIONS, } from './tech-geo';
// Finance variant - these are included in finance builds
export { STOCK_EXCHANGES, FINANCIAL_CENTERS, CENTRAL_BANKS, COMMODITY_HUBS, } from './finance-geo';
...
export { COMMODITY_PRICES, COMMODITY_MARKET_SYMBOLS, } from './commodity-markets';
export { MINING_SITES, PROCESSING_PLANTS, COMMODITY_PORTS, } from './commodity-geo';
