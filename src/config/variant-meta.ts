...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  crypto: {
    title: 'IVEE - Crypto Trading Dashboard',
    description: 'Real-time crypto trading dashboard with whale alerts, trading signals, portfolio tracking, DeFi tokens, AI tokens, stablecoins, ETF flows, and market intelligence powered by AVE.',
    keywords: 'crypto dashboard, trading, bitcoin, ethereum, whale alerts, trading signals, DeFi, AI tokens, stablecoins, ETF flows, crypto news, market data, crypto portfolio, risk scanner',
    url: 'https://www.ivee.app/',
    siteName: 'IVEE',
    shortName: 'IVEE',
    subject: 'Crypto Trading and Market Intelligence',
    classification: 'Crypto Dashboard, Trading Intelligence, DeFi Analytics',
    categories: ['finance', 'news'],
    features: [
      'Real-time crypto price tracking',
      'Whale alert monitoring',
      'Trading signals and risk scanner',
