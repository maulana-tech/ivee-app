...
export const HAPPY_CATEGORY_LABELS = {
...
export const HAPPY_CATEGORY_ALL = [
    'science-health',
    'nature-wildlife',
    'humanity-kindness',
    'innovation-tech',
 ...
 */
export function classifyPositiveContent(title) {
 ...
 */
export function classifyNewsItem(source, title) {
