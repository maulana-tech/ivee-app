...
export function geoConvergenceToSignal(alert) {
...
export function debugGetCells() {
    return new Map(cells);
}
export function getAlertsNearLocation(lat, lon, radiusKm) {
    pruneOldEvents();
    let maxScore = 0;
    let maxTypes = 0;
