...
export function calculateVelocity(cluster) {
...
export function enrichWithVelocity(clusters) {
    return clusters.map(cluster => ({
        ...cluster,
        velocity: calculateVelocity(cluster),
    }));
}
export async function calculateVelocityWithML(cluster) {
...
export async function enrichWithVelocityML(clusters) {
    if (!mlWorker.isAvailable) {
