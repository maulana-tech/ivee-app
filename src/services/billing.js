 ...
 */
export async function initSubscriptionWatch(_userId) {
    if (initialized)
        return;
    try {
        ...
        unsubscribeConvex = client.onUpdate(api.payments.billing.getSubscriptionForUser, {}, (result) => {
