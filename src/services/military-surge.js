...
export function analyzeFlightsForSurge(flights) {
    cleanupOldHistory();
...
export function getActiveSurges() {
    return Array.from(activeSurges.values());
}
export function getTheaterActivity(theaterId) {
...
export function detectForeignMilitaryPresence(flights) {
    const newAlerts = [];
...
export function foreignPresenceToSignal(alert) {
    const aircraftTypes = new Map();
    const callsigns = [];
...
export function getActiveForeignPresence() {
    return Array.from(activeForeignPresence.values());
}
// ============ SURGE DETECTION (baseline-based) ============
export function surgeAlertToSignal(surge) {
    const typeLabels = {
...
export function getTheaterPostureSummaries(flights) {
    const summaries = [];
 ...
 */
export function recalcPostureWithVessels(postures) {
...
export function getCriticalPostures(flights) {
