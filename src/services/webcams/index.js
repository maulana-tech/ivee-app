...
import { WebcamServiceClient, } from '@/generated/client/ivee/webcam/v1/service_client';
const client = new WebcamServiceClient(getRpcBaseUrl(), {
    fetch: (...args) => globalThis.fetch(...args),
});
const emptyResponse = { webcams: [], clusters: [], totalInView: 0 };
...
export async function fetchWebcams(zoom, bounds) {
    try {
...
export async function fetchWebcamImage(webcamId) {
    // Check client cache
