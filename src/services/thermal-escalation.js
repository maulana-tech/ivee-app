...
import { ThermalServiceClient, } from '@/generated/client/ivee/thermal/v1/service_client';
...
export async function fetchThermalEscalations(maxItems = 12) {
    const hydrated = getHydratedData('thermalEscalation');
    ...
    return breaker.execute(async () => {
        const response = await client.listThermalEscalations({ maxItems }, { signal: AbortSignal.timeout(15000) });
        return {
