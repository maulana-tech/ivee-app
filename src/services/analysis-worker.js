 ...
 */
import { SOURCE_TIERS, SOURCE_TYPES } from '@/config/feeds';
...
class AnalysisWorkerManager {
    ...
    request(type, payload, timeoutMs, timeoutMessage) {
    ...
    async clusterNews(items) {
        ...
        return this.request('cluster', { items, sourceTiers: SOURCE_TIERS }, 30000, 'Clustering request timed out');
    }
    /**
    ...
    async analyzeCorrelations(clusters, predictions, markets) {
        ...
        }, 10000, 'Correlation analysis request timed out');
    }
    /**
...
Object.defineProperty(AnalysisWorkerManager, "READY_TIMEOUT_MS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 10000
}); // 10 seconds to become ready
// Singleton instance
