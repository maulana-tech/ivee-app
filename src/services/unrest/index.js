...
import { UnrestServiceClient, } from '@/generated/client/ivee/unrest/v1/service_client';
import { createCircuitBreaker } from '@/utils';
import { getHydratedData } from '@/services/bootstrap';
// ---- Client + Circuit Breaker ----
const client = new UnrestServiceClient(getRpcBaseUrl(), { fetch: (...args) => globalThis.fetch(...args) });
const unrestBreaker = createCircuitBreaker({
    name: 'Unrest Events',
...
export async function fetchProtestEvents() {
    const hydrated = getHydratedData('unrestEvents');
