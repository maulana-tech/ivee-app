 ...
 */
export async function checkWingbitsStatus() {
    if (!isFeatureAvailable('wingbitsEnrichment'))
        return false;
 ...
 */
export async function getAircraftDetailsBatch(icao24List) {
    if (!isFeatureAvailable('wingbitsEnrichment'))
        return new Map();
 ...
 */
export function analyzeAircraftDetails(details) {
    const result = {
 ...
 */
export async function enrichAircraft(icao24) {
 ...
 */
export function clearWingbitsCache() {
    localCache.clear();
    lastCacheSweep = 0;
}
/**
 ...
 */
export async function getWingbitsLiveFlight(icao24) {
    if (!isFeatureAvailable('wingbitsEnrichment'))
        return null;
    try {
