...
import { RadiationServiceClient, } from '@/generated/client/ivee/radiation/v1/service_client';
let latestRadiationWatchResult = null;
...
export async function fetchRadiationWatch() {
    const hydrated = getHydratedData('radiationWatch');
...
export function getLatestRadiationWatch() {
