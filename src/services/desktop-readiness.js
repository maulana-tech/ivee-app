...
export const DESKTOP_PARITY_FEATURES = [
    {
        id: 'live-news',
        panel: 'LiveNewsPanel',
    ...
    },
    {
        ...
        apiHandlers: ['server/ivee/conflict/v1/handler.ts', 'server/ivee/infrastructure/v1/handler.ts', 'server/ivee/cyber/v1/handler.ts', 'server/ivee/maritime/v1/handler.ts', 'server/ivee/military/v1/handler.ts'],
        locality: 'api-key',
    ...
    },
    {
        ...
        apiHandlers: ['server/ivee/news/v1/handler.ts'],
        locality: 'api-key',
    ...
    },
    {
        ...
        apiHandlers: ['server/ivee/market/v1/handler.ts'],
        locality: 'fully-local',
    ...
    },
    {
        ...
        apiHandlers: ['server/ivee/military/v1/handler.ts'],
        locality: 'api-key',
...
export function getNonParityFeatures() {
    return DESKTOP_PARITY_FEATURES.filter(feature => feature.locality !== 'fully-local');
}
export function getDesktopReadinessChecks(localBackendEnabled) {
