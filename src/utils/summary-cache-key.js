...
export function canonicalizeSummaryInputs(headlines, geoContext) {
    return {
...
export function buildSummaryCacheKey(headlines, mode, geoContext, variant, lang, systemAppend) {
