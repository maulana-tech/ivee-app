...
const WIDGET_RELAY_BASE = 'https://proxy.ivee.app';
export function widgetAgentUrl() {
    if (isDev)
        return '/widget-agent';
    if (isDesktopRuntime())
...
export function proxyUrl(localPath) {
    if (isDesktopRuntime()) {
