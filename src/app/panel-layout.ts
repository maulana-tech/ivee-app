...
export class PanelLayoutManager implements AppModule {
  ...
  renderLayout(): void {
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="trade-page-container" id="tradePageContainer"></div>
        ...
        <div class="nba-modal-overlay" id="nbaModalOverlay">
          <div class="nba-modal" id="nbaModal">
            <div class="nba-modal-header">
              ...
              <div class="nba-modal-actions">
                <button class="nba-modal-expand" id="nbaModalExpand" title="Expand to fullscreen">
  ...
  private setupNbaModal(): void {
    ...
    const expandBtn = document.getElementById('nbaModalExpand');

    closeBtn?.addEventListener('click', () => this.closeNbaModal());

    expandBtn?.addEventListener('click', () => {
      modal?.classList.toggle('nba-modal-fullscreen');
    });
  ...
  private closeNbaModal(): void {
    ...
    document.getElementById('nbaModal')?.classList.remove('nba-modal-fullscreen');
