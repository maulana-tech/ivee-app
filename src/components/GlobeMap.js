...
import { getGlobeRenderScale, resolveGlobePixelRatio, resolvePerformanceProfile, subscribeGlobeRenderScaleChange, getGlobeTexture, GLOBE_TEXTURE_URLS, subscribeGlobeTextureChange, getGlobeVisualPreset, subscribeGlobeVisualPresetChange } from '@/services/globe-render-settings';
import { getLayersForVariant, resolveLayerLabel, bindLayerSearch } from '@/config/map-layer-definitions';
import { getSecretState } from '@/services/runtime-config';
import { resolveTradeRouteSegments } from '@/config/trade-routes';
...
const SAT_COUNTRY_COLORS = { CN: '#ff2020', RU: '#ff8800', US: '#4488ff', EU: '#44cc44', KR: '#aa66ff', IN: '#ff66aa', TR: '#ff4466', OTHER: '#ccccff' };
const SAT_TYPE_EMOJI = { sar: '\u{1F4E1}', optical: '\u{1F4F7}', military: '\u{1F396}', sigint: '\u{1F4FB}' };
const SAT_TYPE_LABEL = { sar: 'SAR Imaging', optical: 'Optical Imaging', military: 'Military', sigint: 'SIGINT' };
const SAT_OPERATOR_NAME = { CN: 'China', RU: 'Russia', US: 'United States', EU: 'ESA / EU', KR: 'South Korea', IN: 'India', TR: 'Turkey', OTHER: 'Other' };
export class GlobeMap {
    constructor(container, initialState) {
        ...
        Object.defineProperty(this, "unsubscribeGlobeQuality", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "unsubscribeGlobeTexture", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "unsubscribeVisualPreset", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "savedDefaultMaterial", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "cyanLight", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "extrasAnimFrameId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "pendingFlushWhilePaused", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "controlsAutoRotateBeforePause", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "controlsDampingBeforePause", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "flushMaxTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "_pulseEnabled", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        });
        Object.defineProperty(this, "reversedRingCache", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "isGlobeAnimating", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        ...
        Object.defineProperty(this, "flights", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "vesselData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "flightData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "clusterMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "clusterData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "weatherMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "naturalMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "iranMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "outageMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "trafficAnomalyMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "ddosMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "cyberMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "fireMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "protestMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "ucdpMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "displacementMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "climateMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "gpsJamMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "techMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "conflictZoneMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "milBaseMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "nuclearSiteMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "irradiatorSiteMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "spaceportSiteMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "earthquakeMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "radiationMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "economicMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "datacenterMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "waterwayMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "mineralMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "flightDelayMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "notamRingMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "newsLocationMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "flashMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "cableAdvisoryMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "repairShipMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "aisMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "satelliteMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "satelliteTrailPaths", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "stormTrackPaths", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "stormConePolygons", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "satelliteFootprintMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "imagerySceneMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "webcamMarkers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "webcamMarkerMode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: localStorage.getItem('wm-webcam-marker-mode') || 'icon'
        });
        Object.defineProperty(this, "imageryFootprintPolygons", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "lastImageryCenter", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "imageryFetchTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "imageryFetchVersion", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "controlsEndHandler", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "satBeamGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "globePaths", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "cableFaultIds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set()
        });
        Object.defineProperty(this, "cableDegradedIds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set()
        ...
        Object.defineProperty(this, "countriesGeoData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        // Click callbacks
        Object.defineProperty(this, "onHotspotClickCb", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "autoRotateTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        // Overlay UI elements
        Object.defineProperty(this, "layerTogglesEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "tooltipHideTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "satHoverStyle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        // Callbacks
        Object.defineProperty(this, "onLayerChangeCb", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "onMapContextMenuCb", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "handleContextMenu", {
            ...
            value: (e) => {
                e.preventDefault();
                if (!this.onMapContextMenuCb || !this.globe)
                    return;
    ...
    async initGlobe() {
        ...
        const globe = new Globe(this.container, config);
        if (this.destroyed) {
            globe._destructor();
            return;
        }
        ...
        globe
            ...
            .htmlAltitude((d) => {
            const m = d;
            if (m._kind === 'satFootprint')
                return 0;
            if (m._kind === 'satellite')
                return m.alt / 6371;
            if (m._kind === 'flight' || m._kind === 'vessel' || m._kind === 'cluster')
                return 0.012;
            if (m._kind === 'hotspot')
                return 0.005;
            return 0.003;
        })
            .htmlElement((d) => this.buildMarkerElement(d));
        // Arc accessors — set once, only data changes on flush
        globe
            .arcStartLat((d) => d.sourcePosition[1])
            .arcStartLng((d) => d.sourcePosition[0])
            .arcEndLat((d) => d.targetPosition[1])
            .arcEndLng((d) => d.targetPosition[0])
            .arcColor((d) => {
            ...
            .arcLabel((d) => `${d.routeName} · ${d.volumeDesc}`);
        // Path accessors — set once
        globe
            .pathPoints((d) => d?.points ?? [])
            .pathPointLat((p) => p[1])
            .pathPointLng((p) => p[0])
            .pathPointAlt((p, _idx, path) => path?.pathType === 'orbit' && p.length > 2 ? (p[2] ?? 0) / 6371 : 0)
            .pathColor((d) => {
            if (!d)
                return 'rgba(180,160,255,0.6)';
            if (d.pathType === 'orbit') {
                const colors = { CN: 'rgba(255,32,32,0.4)', RU: 'rgba(255,136,0,0.4)', US: 'rgba(68,136,255,0.4)', EU: 'rgba(68,204,68,0.4)' };
                return colors[d.country || ''] || 'rgba(200,200,255,0.3)';
            }
            if (d.pathType === 'cable') {
                if (this.cableFaultIds.has(d.id))
                    return '#ff3030';
                if (this.cableDegradedIds.has(d.id))
                    return '#ff8800';
            ...
            if (d.pathType === 'gas')
                return 'rgba(80,220,120,0.6)';
            if (d.pathType === 'stormTrack')
                return 'rgba(255,100,100,0.8)';
            if (d.pathType === 'stormHistory') {
                const w = d.windKt || 0;
                if (w >= 137)
                    return 'rgba(255,96,96,0.8)';
                if (w >= 96)
                    return 'rgba(255,140,0,0.8)';
                if (w >= 64)
                    return 'rgba(255,231,117,0.8)';
                if (w >= 34)
                    return 'rgba(94,186,255,0.8)';
        ...
        globe
            ...
            if (d._kind === 'imageryFootprint')
                return 'rgba(0,0,0,0)';
            if (d._kind === 'forecastCone')
                return 'rgba(255,140,60,0.2)';
            ...
            if (d._kind === 'imageryFootprint') {
                ...
                if (d.resolutionM != null || d.mode) {
                    const parts = [];
                    if (d.resolutionM != null)
                        parts.push(`${d.resolutionM}m`);
                    if (d.mode)
                        parts.push(escapeHtml(d.mode));
    ...
    buildMarkerElement(d) {
        ...
        <div style="position:relative;width:${size}px;height:${size}px;">
          ...
          "></div>
            ...
            const colors = { 5: '#ff2020', 4: '#ff6600', 3: '#ffaa00', 2: '#ffdd00', 1: '#88ff44' };
        ...
        <div style="transform:rotate(${heading}deg);font-size:11px;color:${color};text-shadow:0 0 4px ${color}88;line-height:1;">
          ✈
            ...
            const usniRing = d.usniSource
                ...
                : '';
            el.innerHTML = GlobeMap.wrapHit(`<div style="position:relative;display:inline-flex;align-items:center;justify-content:center;">` +
                darkRing +
                usniRing +
            ...
            el.innerHTML = GlobeMap.wrapHit(`<div style="position:relative;display:inline-flex;align-items:center;justify-content:center;width:${sz}px;height:${sz}px;">` +
            ...
            const confirmRing = d.corroborated
                ...
                : '';
            el.innerHTML = GlobeMap.wrapHit(`<div style="position:relative;display:inline-flex;align-items:center;justify-content:center;">${ring}${confirmRing}<div style="font-size:11px;color:${c};text-shadow:0 0 5px ${c}88;opacity:${d.confidence === 'low' ? 0.75 : 1};">☢</div></div>`);
        ...
        <div style="position:relative;width:${size}px;height:${size}px;">
          <div style="position:absolute;inset:0;border-radius:50%;background:rgba(255,100,0,0.85);border:1.5px solid rgba(255,160,80,0.9);box-shadow:0 0 5px 2px rgba(255,100,0,0.5);"></div>
            ...
            const typeColors = { warm: '#ff4400', cold: '#44aaff', wet: '#00ccff', dry: '#ff8800', mixed: '#88ff88' };
        ...
        <div style="position:relative;width:16px;height:16px;">
          ...
          <div style="position:absolute;inset:-5px;border-radius:50%;background:${tc}22;${this.pulseStyle('1.8s')}"></div>
            ...
            const c = SAT_COUNTRY_COLORS[d.country] || '#ccccff';
            ...
            const colors = { CN: '#ff2020', RU: '#ff8800', US: '#4488ff', EU: '#44cc44' };
            const c = colors[d.country] || '#ccccff';
    ...
    handleMarkerClick(d, anchor) {
        if (d._kind === 'hotspot' && this.onHotspotClickCb) {
            this.onHotspotClickCb({
                ...
                lon: d._lng,
                keywords: [],
                escalationScore: d.escalationScore,
            });
        }
    ...
    showMarkerTooltip(d, anchor) {
        ...
        if (d._kind === 'conflict') {
            ...
            const typeColors = { riot: '#ff3030', strike: '#44aaff', protest: '#ffaa00' };
            const c = typeColors[d.eventType] ?? '#ffaa00';
        ...
        const left = Math.max(4, Math.min(ar.left - cr.left + (anchor.offsetWidth ?? 14) + 6, cr.width - el.offsetWidth - 4));
    ...
    createLayerToggles() {
        const layerDefs = getLayersForVariant((SITE_VARIANT || 'full'), 'globe');
      ...
      <div class="toggle-list" style="max-height:32vh;overflow-y:auto;scrollbar-width:thin;">
        ...
        el.querySelectorAll('.layer-toggle input').forEach(input => {
            input.addEventListener('change', () => {
                ...
                if (layer) {
                    ...
                    if (layer === 'webcams') {
                        const modeRow = el.querySelector('.webcam-mode-row');
                        if (modeRow)
                            modeRow.style.display = checked ? '' : 'none';
                    }
                }
            });
        });
        // ── Webcam marker-mode sub-toggle ────────────────────────────────────────
        const webcamToggleEl = el.querySelector('.layer-toggle[data-layer="webcams"]');
        if (webcamToggleEl) {
            ...
            const currentMode = () => localStorage.getItem('wm-webcam-marker-mode') || 'icon';
            const renderModeLabel = () => currentMode() === 'emoji' ? '&#128247; icon mode' : '&#128512; emoji mode';
            ...
            if (this.layers.webcams)
                modeRow.style.display = '';
        }
        this.enforceLayerLimit();
        bindLayerSearch(el);
        const searchEl = el.querySelector('.layer-search');
        const collapseBtn = el.querySelector('.toggle-collapse');
        const list = el.querySelector('.toggle-list');
        let collapsed = false;
        collapseBtn?.addEventListener('click', () => {
            ...
            if (searchEl)
                searchEl.style.display = collapsed ? 'none' : '';
            if (collapseBtn)
    ...
    flushMarkersImmediate() {
        if (!this.globe || !this.initialized || this.destroyed || this.webglLost)
            return;
        this.wakeGlobe();
        const markers = [];
        if (this.layers.hotspots)
            markers.push(...this.hotspots);
        if (this.layers.conflicts)
            markers.push(...this.conflictZoneMarkers);
        if (this.layers.bases)
            markers.push(...this.milBaseMarkers);
        if (this.layers.nuclear)
            markers.push(...this.nuclearSiteMarkers);
        if (this.layers.irradiators)
            markers.push(...this.irradiatorSiteMarkers);
        if (this.layers.spaceports)
            markers.push(...this.spaceportSiteMarkers);
        ...
        if (this.layers.weather)
            markers.push(...this.weatherMarkers);
        if (this.layers.natural) {
            markers.push(...this.naturalMarkers);
            markers.push(...this.earthquakeMarkers);
        }
        if (this.layers.radiationWatch)
            markers.push(...this.radiationMarkers);
        if (this.layers.economic)
            markers.push(...this.economicMarkers);
        if (this.layers.datacenters)
            markers.push(...this.datacenterMarkers);
        if (this.layers.waterways)
            markers.push(...this.waterwayMarkers);
        if (this.layers.minerals)
            markers.push(...this.mineralMarkers);
        if (this.layers.flights) {
            markers.push(...this.flightDelayMarkers);
            markers.push(...this.notamRingMarkers);
        }
        if (this.layers.ais)
            markers.push(...this.aisMarkers);
        if (this.layers.iranAttacks)
            markers.push(...this.iranMarkers);
        ...
        if (this.layers.cyberThreats)
            markers.push(...this.cyberMarkers);
        if (this.layers.fires)
            markers.push(...this.fireMarkers);
        if (this.layers.protests)
            markers.push(...this.protestMarkers);
        if (this.layers.ucdpEvents)
            markers.push(...this.ucdpMarkers);
        if (this.layers.displacement)
            markers.push(...this.displacementMarkers);
        if (this.layers.climate)
            markers.push(...this.climateMarkers);
        if (this.layers.gpsJamming)
            markers.push(...this.gpsJamMarkers);
        if (this.layers.satellites) {
            markers.push(...this.satelliteMarkers);
            markers.push(...this.satelliteFootprintMarkers);
            markers.push(...this.imagerySceneMarkers);
        }
        if (this.layers.techEvents)
            markers.push(...this.techMarkers);
        if (this.layers.cables) {
            markers.push(...this.cableAdvisoryMarkers);
            markers.push(...this.repairShipMarkers);
        }
        if (this.layers.webcams)
            markers.push(...this.webcamMarkers);
        ...
        try {
            ...
            if (import.meta.env.DEV)
                console.warn('[GlobeMap] flush error', err);
        }
    }
    flushArcs() {
        if (!this.globe || !this.initialized || this.destroyed || this.webglLost)
    ...
    flushPaths() {
        ...
        this.globe.pathsData([...paths, ...orbitPaths, ...stormPaths]);
    }
    getReversedRing(zoneId, countryIso, ringIdx, ring) {
        const key = `${zoneId}:${countryIso}:${ringIdx}`;
        let cached = this.reversedRingCache.get(key);
        if (!cached) {
            cached = ring.map((r) => [...r].reverse());
            ...
            for (const z of CONFLICT_ZONES) {
                ...
                if (isoCodes && this.countriesGeoData) {
                    for (const feat of this.countriesGeoData.features) {
                        ...
                        if (!code || !isoCodes.includes(code))
                            continue;
                        ...
                        for (let ri = 0; ri < rings.length; ri++) {
                            polys.push({
                                coords: this.getReversedRing(z.id, code, ri, rings[ri]),
                                name: z.name,
                                _kind: 'conflict',
    ...
    initStaticLayers() {
        for (const k of Object.keys(this.layers)) {
            if (this.layers[k])
                this.ensureStaticDataForLayer(k);
        }
    }
    ensureStaticDataForLayer(layer) {
        switch (layer) {
            case 'bases':
                if (!this.milBaseMarkers.length) {
                    this.milBaseMarkers = MILITARY_BASES.map(b => ({
                        _kind: 'milbase',
                        _lat: b.lat,
                        _lng: b.lon,
                        id: b.id,
            ...
            case 'irradiators':
                if (!this.irradiatorSiteMarkers.length) {
                    this.irradiatorSiteMarkers = GAMMA_IRRADIATORS.map(g => ({
                        _kind: 'irradiator',
                        _lat: g.lat,
                        _lng: g.lon,
                        id: g.id,
            ...
            case 'spaceports':
                if (!this.spaceportSiteMarkers.length) {
                    this.spaceportSiteMarkers = SPACEPORTS
            ...
            case 'economic':
                if (!this.economicMarkers.length) {
                    this.economicMarkers = ECONOMIC_CENTERS.map(c => ({
                        _kind: 'economic',
                        _lat: c.lat,
                        _lng: c.lon,
                        id: c.id,
            ...
            case 'datacenters':
                if (!this.datacenterMarkers.length) {
                    this.datacenterMarkers = AI_DATA_CENTERS
            ...
            case 'waterways':
                if (!this.waterwayMarkers.length) {
                    this.waterwayMarkers = STRATEGIC_WATERWAYS.map(w => ({
                        _kind: 'waterway',
                        _lat: w.lat,
                        _lng: w.lon,
                        id: w.id,
            ...
            case 'minerals':
                if (!this.mineralMarkers.length) {
                    this.mineralMarkers = CRITICAL_MINERALS
    ...
    setMilitaryFlights(flights) {
        ...
        this.flights = flights.map(f => ({
            ...
            id: f.id,
            callsign: f.callsign ?? '',
            type: f.aircraftType ?? f.type ?? 'fighter',
            heading: f.heading ?? 0,
        }));
        this.flushMarkers();
    }
    setMilitaryVessels(vessels, clusters = []) {
        ...
        for (const v of vessels)
            this.vesselData.set(v.id, v);
        this.clusterData.clear();
        for (const c of clusters)
            this.clusterData.set(c.id, c);
    ...
    enableLayer(layer) {
        ...
        const toggle = this.layerTogglesEl?.querySelector(`.layer-toggle[data-layer="${layer}"] input`);
        if (toggle)
            toggle.checked = true;
        this.flushLayerChannels(layer);
        this.enforceLayerLimit();
    ...
    enforceLayerLimit() {
        if (!this.layerTogglesEl)
            return;
        const WARN_THRESHOLD = 13;
        const activeCount = Array.from(this.layerTogglesEl.querySelectorAll('.layer-toggle input'))
    ...
    // ─── Callback setters ─────────────────────────────────────────────────────
    setOnHotspotClick(cb) {
        this.onHotspotClickCb = cb;
    }
    setOnCountryClick(_cb) {
    ...
    updateHotspotActivity(_news) { }
    updateMilitaryForEscalation(_f, _v) { }
    getHotspotDynamicScore(_id) { return undefined; }
    getHotspotLevels() { return {}; }
    setHotspotLevels(_l) { }
    initEscalationGetters() { }
    highlightAssets(_assets) { }
    setOnLayerChange(cb) {
        this.onLayerChangeCb = cb;
    }
    setOnTimeRangeChange(_cb) { }
    ...
    flashAssets(_type, _ids) { }
    flashLocation(lat, lon, durationMs = 2000) {
        if (!this.globe || !this.initialized)
            return;
    ...
    triggerHotspotClick(_id) { }
    triggerConflictClick(_id) { }
    triggerBaseClick(_id) { }
    triggerPipelineClick(_id) { }
    triggerCableClick(_id) { }
    triggerDatacenterClick(_id) { }
    triggerNuclearClick(_id) { }
    triggerIrradiatorClick(_id) { }
    fitCountry(code) {
        if (!this.globe)
            return;
    ...
    async fetchImageryForViewport() {
        ...
        try {
            ...
            if (thisVersion !== this.imageryFetchVersion)
                return;
    ...
    setAisData(disruptions, _density) {
    ...
    setPositiveEvents(_events) { }
    setKindnessData(_points) { }
    setChokepointData(data) {
        this.popup?.setChokepointData(data);
    }
    setHappinessScores(_data) { }
    setSpeciesRecoveryZones(_zones) { }
    setRenewableInstallations(_installations) { }
    ...
    setWebcams(markers) {
        this.webcamMarkers = markers.map(m => {
            if ('count' in m) {
                return { _kind: 'webcam-cluster', _lat: m.lat, _lng: m.lng, count: m.count, categories: m.categories || [] };
            }
            return { _kind: 'webcam', _lat: m.lat, _lng: m.lng, webcamId: m.webcamId, title: m.title, category: m.category || 'other', country: m.country || '' };
        });
        this.flushMarkers();
    }
    ...
    static latLngAltToVec3(lat, lng, alt, vec3Ctor) {
        const GLOBE_R = 100;
        const r = GLOBE_R * (1 + alt / 6371);
        const phi = (90 - lat) * (Math.PI / 180);
        const theta = (90 - lng) * (Math.PI / 180);
        const sinPhi = Math.sin(phi);
        return new vec3Ctor(r * sinPhi * Math.cos(theta), r * Math.cos(phi), r * sinPhi * Math.sin(theta));
    }
    async rebuildSatBeams(positions) {
        if (!this.globe || this.destroyed)
            return;
        ...
        if (this.satBeamGroup) {
            ...
            this.satBeamGroup.traverse((child) => {
                if (child.geometry)
        ...
        if (!this.layers.satellites || positions.length === 0)
            return;
        const colorMap = {
    ...
    onHotspotClicked(cb) { this.onHotspotClickCb = cb; }
    onTimeRangeChanged(_cb) { }
    onStateChanged(_cb) { }
    setOnCountry(_cb) { }
    getHotspotLevel(_id) { return 'low'; }
    async applyEnhancedVisuals() {
        if (!this.globe || this.destroyed)
            return;
        try {
            const THREE = await import('three');
            ...
            if (oldMat) {
                ...
                if (oldMat.map)
                    stdMat.map = oldMat.map;
                this.globe.globeMaterial(stdMat);
            }
    ...
    startExtrasLoop() {
        ...
        const animateExtras = () => {
            if (this.destroyed)
                return;
            if (this.outerGlow)
                this.outerGlow.rotation.y += 0.0003;
            if (this.starField)
    ...
    removeEnhancedVisuals() {
        ...
        if (mat && mat.isMeshStandardMaterial) {
            ...
            if (this.savedDefaultMaterial) {
                if (texMap)
                    this.savedDefaultMaterial.map = texMap;
                this.globe.globeMaterial(this.savedDefaultMaterial);
            }
        }
        this.outerGlow = null;
        this.innerGlow = null;
    ...
    applyRenderQuality(scale, width, height) {
        if (!this.globe)
            return;
        try {
            const desktop = isDesktopRuntime();
    ...
    applyPerformanceProfile(profile) {
        ...
        if (profile.disableDashAnimations) {
            this.globe.arcDashAnimateTime(0);
            this.globe.pathDashAnimateTime(0);
        }
        else {
            this.globe.arcDashAnimateTime(5000);
            this.globe.pathDashAnimateTime((d) => {
                if (!d)
                    return 5000;
                if (d.pathType === 'orbit')
                    return 0;
    ...
    scheduleIdlePause() {
        ...
        this.idleTimer = setTimeout(() => {
            if (this.destroyed || !this.globe || this.renderPaused)
                return;
...
Object.defineProperty(GlobeMap, "CII_GLOBE_COLORS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
Object.defineProperty(GlobeMap, "CONFLICT_CAP", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: { high: 'rgba(255,40,40,0.25)', medium: 'rgba(255,120,0,0.20)', low: 'rgba(255,200,0,0.15)' }
});
Object.defineProperty(GlobeMap, "CONFLICT_SIDE", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: { high: 'rgba(255,40,40,0.12)', medium: 'rgba(255,120,0,0.08)', low: 'rgba(255,200,0,0.06)' }
});
Object.defineProperty(GlobeMap, "CONFLICT_STROKE", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: { high: '#ff3030', medium: '#ff8800', low: '#ffcc00' }
});
Object.defineProperty(GlobeMap, "CONFLICT_ALT", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: { high: 0.006, medium: 0.004, low: 0.003 }
});
Object.defineProperty(GlobeMap, "FLIGHT_TYPE_COLORS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
Object.defineProperty(GlobeMap, "VESSEL_TYPE_COLORS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
Object.defineProperty(GlobeMap, "VESSEL_TYPE_ICONS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
Object.defineProperty(GlobeMap, "CLUSTER_ACTIVITY_COLORS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
Object.defineProperty(GlobeMap, "VESSEL_TYPE_LABELS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
// ─── Layer control ────────────────────────────────────────────────────────
Object.defineProperty(GlobeMap, "LAYER_CHANNELS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new Map([
...
// ─── Camera / navigation ──────────────────────────────────────────────────
Object.defineProperty(GlobeMap, "VIEW_POVS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
