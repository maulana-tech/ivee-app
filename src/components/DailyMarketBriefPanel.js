...
function formatGeneratedTime(isoTimestamp, timezone) {
    try {
...
export class DailyMarketBriefPanel extends Panel {
    ...
    showUnavailable(message = 'The daily brief needs live market data before it can be generated.') {
