...
let correlationBootstrap;
function getCorrelationBootstrap() {
    if (correlationBootstrap === undefined) {
        correlationBootstrap = getHydratedData('correlationCards') ?? null;
    }
...
export class CorrelationPanel extends Panel {
    constructor(id, title, domain, infoTooltip) {
        ...
        Object.defineProperty(this, "expandedCard", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "onMapNavigate", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "boundUpdateHandler", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "hasLiveData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "pendingRender", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    populateDetail(el, card) {
        const signalList = card.signals.slice(0, 10).map(s => h('div', { style: 'padding:2px 0;display:flex;gap:6px;align-items:baseline;' }, h('span', {
            style: 'font-size:8px;padding:1px 4px;border-radius:3px;background:rgba(255,255,255,0.1);white-space:nowrap;',
        }, s.type), h('span', { style: 'opacity:0.8;' }, s.label)));
        const children = [
