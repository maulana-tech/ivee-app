...
export class CIIPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "focalPointsReady", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "hasCachedRender", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    buildCountry(country) {
        ...
        return h('div', { className: 'cii-country', dataset: { code: country.code } }, h('div', { className: 'cii-header' }, h('span', { className: 'cii-emoji' }, emoji), h('span', { className: 'cii-name' }, country.name), h('span', { className: 'cii-score' }, String(country.score)), this.buildTrendArrow(country.trend, country.change24h), shareBtn), h('div', { className: 'cii-bar-container' }, h('div', { className: 'cii-bar', style: `width: ${country.score}%; background: ${color};` })), h('div', { className: 'cii-components' }, h('span', { title: t('common.unrest') }, `U:${country.components.unrest}`), h('span', { title: t('common.conflict') }, `C:${country.components.conflict}`), h('span', { title: t('common.security') }, `S:${country.components.security}`), h('span', { title: t('common.information') }, `I:${country.components.information}`)));
    }
    bindShareButtons() {
        if (!this.onShareStory && !this.onCountryClick)
            return;
        ...
        this.content.querySelectorAll('.cii-share-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (code && name && this.onShareStory)
...
Object.defineProperty(CIIPanel, "SHARE_SVG", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12v7a2 2 0 002 2h12a2 2 0 002-2v-7"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg>'
});
