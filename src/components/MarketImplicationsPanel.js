...
export class MarketImplicationsPanel extends Panel {
    constructor() {
        ...
        this.content.addEventListener('click', (e) => {
            ...
            const logicEl = this.content.querySelector(`#chain-logic-${chainId}`);
            if (!logicEl)
                return;
    ...
    renderImplications(data, source = 'live') {
    ...
    showUnavailable(message = 'AI market implications are generated after each forecast run. Check back shortly.') {
