...
export class NewsPanel extends Panel {
    setRiskScoreGetter(fn) {
        this.riskScoreGetter = fn;
    }
    constructor(id, title, infoTooltip) {
        super({ id, title, showCount: true, trackActivity: true, infoTooltip });
        Object.defineProperty(this, "clusteredMode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        });
        Object.defineProperty(this, "deviationEl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "relatedAssetContext", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "onRelatedAssetClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onRelatedAssetsFocus", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onRelatedAssetsClear", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "isFirstRender", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        });
        Object.defineProperty(this, "windowedList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "useVirtualScroll", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        });
        Object.defineProperty(this, "renderRequestId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "boundScrollHandler", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "sortBtn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastRawClusters", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastRawItems", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "summaryBtn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "summaryContainer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "lastHeadlineSignature", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ''
        });
        Object.defineProperty(this, "isSummarizing", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "riskScoreGetter", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    initWindowedList() {
        this.windowedList = new WindowedList({
    ...
    createSummarizeButton() {
        ...
        this.summaryContainer.addEventListener('click', (e) => {
            if (e.target.closest('.panel-summary-close')) {
                this.hideSummary();
            }
        });
    ...
    showSummary(summary) {
        if (!this.summaryContainer || !this.element?.isConnected)
            return;
        this.summaryContainer.style.display = 'block';
    ...
    setupContentDelegation() {
        this.content.addEventListener('click', (e) => {
            ...
            const assetBtn = target.closest('.related-asset');
            if (assetBtn) {
                e.stopPropagation();
                const clusterId = assetBtn.dataset.clusterId;
                const assetId = assetBtn.dataset.assetId;
                const assetType = assetBtn.dataset.assetType;
            ...
            const translateBtn = target.closest('.item-translate-btn');
            if (translateBtn) {
                e.stopPropagation();
                const text = translateBtn.dataset.text;
                if (text)
                    this.handleTranslate(translateBtn, text);
                return;
            }
        });
        this.content.addEventListener('mouseover', (e) => {
            const container = e.target.closest('.related-assets');
            if (!container)
                return;
    ...
    hasNewsItem(link) {
        if (this.lastRawClusters) {
            return this.lastRawClusters.some(c => c.primaryLink === link || c.allItems.some(i => i.link === link));
        }
    ...
    scrollToNewsItem(link) {
        ...
        if (this.lastRawClusters && this.windowedList) {
            const found = this.windowedList.scrollToItem((p) => p.cluster.primaryLink === link || p.cluster.allItems.some((i) => i.link === link));
            if (found) {
                setTimeout(() => {
