...
import { getIranEventCssColor, getIranEventSize } from '@/services/conflict';
import { getNaturalEventIcon } from '@/services/eonet';
import { getSeverityColor } from '@/services/weather';
import { startSmartPollLoop } from '@/services/runtime';
import { MAP_URLS, INTEL_HOTSPOTS, CONFLICT_ZONES, MILITARY_BASES, UNDERSEA_CABLES, NUCLEAR_FACILITIES, GAMMA_IRRADIATORS, PIPELINES, PIPELINE_COLORS, SANCTIONED_COUNTRIES, STRATEGIC_WATERWAYS, ECONOMIC_CENTERS, AI_DATA_CENTERS, PORTS, SPACEPORTS, CRITICAL_MINERALS, SITE_VARIANT, 
// Tech variant data
STARTUP_HUBS, ACCELERATORS, TECH_HQS, CLOUD_REGIONS, 
// Finance variant data
STOCK_EXCHANGES, FINANCIAL_CENTERS, CENTRAL_BANKS, COMMODITY_HUBS, } from '@/config';
...
export class MapComponent {
    constructor(container, initialState) {
        ...
        Object.defineProperty(this, "clusterCanvas", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "clusterGl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "countryFeatures", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "baseLayerGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "dynamicLayerGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "baseRendered", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "techActivities", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "geoActivities", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "onTechHubClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onGeoHubClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "layerZoomOverrides", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {}
        ...
        Object.defineProperty(this, "renderScheduled", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "MIN_RENDER_INTERVAL_MS", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 100
        });
        Object.defineProperty(this, "healthCheckLoop", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    createLayerToggles() {
        ...
        const enforceLayerLimit = () => {
            const allBtns = Array.from(toggles.querySelectorAll('.layer-toggle'));
    ...
    setupZoomHandlers() {
        ...
        this.container.addEventListener('touchmove', (e) => {
            ...
            if (e.touches.length === 2 && touch1 && touch2) {
                ...
                if (!touchDragActive) {
                    ...
                    if (Math.hypot(dx0, dy0) < TOUCH_DRAG_THRESHOLD)
                        return;
        ...
        this.container.addEventListener('click', (e) => {
            if (!this.onCountryClick)
                return;
            if (performance.now() - lastDragEndTime < 300)
                return;
    ...
    renderOverlays(projection) {
        ...
        if (this.state.layers.webcams && this.webcamData.length > 0 && this.state.zoom >= 2) {
            ...
            this.webcamData.forEach((cam) => {
                ...
                const size = radius * 2;
                const color = isCluster ? '#00d4ff' : (CATEGORY_COLORS[cam.category] ?? '#888888');
                const dot = document.createElement('div');
                ...
                dot.title = isCluster ? `${cam.count} webcams` : (cam.title || 'Webcam');
    ...
    placeWebcamTooltip(tooltip, clientX, clientY) {
        const rect = this.container.getBoundingClientRect();
        ...
        let hideTimer = setTimeout(() => tooltip.remove(), 8000);
        tooltip.addEventListener('mouseenter', () => { if (hideTimer) {
            clearTimeout(hideTimer);
            hideTimer = null;
        } });
        tooltip.addEventListener('mouseleave', () => { hideTimer = setTimeout(() => tooltip.remove(), 2000); });
    }
    showWebcamTooltip(cam, clientX, clientY) {
    ...
    showWebcamClusterPopup(cam, clientX, clientY) {
        const { tooltip } = this.makeWebcamTooltipShell();
...
Object.defineProperty(MapComponent, "LAYER_ZOOM_THRESHOLDS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
Object.defineProperty(MapComponent, "ASYNC_DATA_LAYERS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new Set([
