...
export class OrefSirensPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "historyCount24h", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "totalHistoryCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "historyWaves", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "historyFetchInFlight", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "historyLastFetchAt", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    loadHistory() {
        if (this.historyFetchInFlight)
            return;
        if (Date.now() - this.historyLastFetchAt < HISTORY_TTL)
            return;
    ...
    formatAlertTime(dateStr) {
        try {
            ...
            if (diff < 60000)
                return t('components.orefSirens.justNow');
