...
export class EnergyComplexPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "tape", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "crudeWeeks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "natGasWeeks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "euGas", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "oilStocksAnalysis", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lngVulnerability", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    renderLngVulnerabilitySection() {
        const d = this.lngVulnerability;
        if (!d || d.top20LngDependent.length === 0)
            return '';
    ...
    render() {
        ...
        const footerParts = [];
        if (hasAnalytics(this.analytics))
            footerParts.push('EIA');
        if (this.tape.length > 0)
            footerParts.push(t('components.energyComplex.liveTapeSource'));
        if (this.euGas)
            footerParts.push('GIE AGSI+');
        if (this.oilStocksAnalysis)
            footerParts.push('IEA');
        if (this.lngVulnerability)
            footerParts.push('JODI Gas');
