...
export const OPTIONAL_LIVE_CHANNELS = [
...
export function getDefaultLiveChannels() {
...
export function getFilteredOptionalChannels(userCountry) {
    if (!userCountry)
...
export function getFilteredChannelRegions(userCountry) {
    if (!userCountry)
        return OPTIONAL_CHANNEL_REGIONS;
...
export function loadChannelsFromStorage() {
    const stored = loadFromStorage(STORAGE_KEYS.liveChannels, DEFAULT_STORED);
...
export class LiveNewsPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "activeChannel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "channelSwitcher", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "wasPlayingBeforeIdle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        });
        Object.defineProperty(this, "muteBtn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "liveBtn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "ECO_IDLE_PAUSE_MS", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: IDLE_PAUSE_MS
        ...
        Object.defineProperty(this, "playerContainer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "playerElementId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "currentVideoId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "youtubeOrigin", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "forceFallbackVideoForNextInit", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "useDesktopEmbedProxy", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: isDesktopRuntime()
        });
        Object.defineProperty(this, "desktopEmbedIframe", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "desktopEmbedRenderToken", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "suppressChannelClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "boundMessageHandler", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "muteSyncInterval", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "botCheckTimeout", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "nativeVideoElement", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "hlsFailureCooldown", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "HLS_COOLDOWN_MS", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 5 * 60 * 1000
        });
        Object.defineProperty(this, "deferredInit", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "lazyObserver", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "idleCallbackId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        const savedChannelId = loadFromStorage(STORAGE_KEYS.activeChannel, '');
    ...
    async renderDesktopEmbedAsync(force = false) {
        ...
        params.set('origin', this.youtubeOrigin || 'https://ivee.app');
    ...
    async renderNativeHlsPlayer() {
        ...
        if (nativeHls) {
            ...
            if (this.activeChannel.id !== failedChannel.id || !this.element?.isConnected)
                return;
            if (!Hls.isSupported()) {
    ...
    async initializePlayer() {
        ...
        if (this.playerContainer) {
            ...
            observerTimeout = setTimeout(() => storageObserver.disconnect(), 10000);
        }
        try {
...
Object.defineProperty(LiveNewsPanel, "apiPromise", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: null
});
Object.defineProperty(LiveNewsPanel, "MUTE_SYNC_POLL_MS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 500
});
Object.defineProperty(LiveNewsPanel, "BOT_CHECK_TIMEOUT_MS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 15000
