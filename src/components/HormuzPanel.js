...
function barChart(series, color, unit, width = 280, height = 52) {
    if (!series.length)
...
function renderChart(chart, idx) {
...
export class HormuzPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "tooltipBound", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    bindTooltip() {
        if (this.tooltipBound || !this.element)
            return;
