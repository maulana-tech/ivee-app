...
import { recalcPostureWithVessels } from '@/services/military-surge';
...
export class StrategicPosturePanel extends Panel {
    constructor(getLatestNews) {
        ...
        Object.defineProperty(this, "getLatestNews", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: getLatestNews
        });
        Object.defineProperty(this, "postures", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "vesselTimeouts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "loadingElapsedInterval", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "loadingStartTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "onLocationClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    renderTheater(p) {
      ...
      `;
        ...
        const airChips = [];
        if (p.fighters > 0)
            airChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.fighters')}">✈️ ${p.fighters}</span>`);
        if (p.tankers > 0)
            airChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.tankers')}">⛽ ${p.tankers}</span>`);
        if (p.awacs > 0)
            airChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.awacs')}">📡 ${p.awacs}</span>`);
        if (p.reconnaissance > 0)
            airChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.recon')}">🔍 ${p.reconnaissance}</span>`);
        if (p.transport > 0)
            airChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.transport')}">📦 ${p.transport}</span>`);
        if (p.bombers > 0)
            airChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.bombers')}">💣 ${p.bombers}</span>`);
        if (p.drones > 0)
            airChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.drones')}">🛸 ${p.drones}</span>`);
        ...
        const navalChips = [];
        if (p.carriers > 0)
            navalChips.push(`<span class="posture-stat carrier" title="${t('components.strategicPosture.units.carriers')}">🚢 ${p.carriers}</span>`);
        if (p.destroyers > 0)
            navalChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.destroyers')}">⚓ ${p.destroyers}</span>`);
        if (p.frigates > 0)
            navalChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.frigates')}">🛥️ ${p.frigates}</span>`);
        if (p.submarines > 0)
            navalChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.submarines')}">🦈 ${p.submarines}</span>`);
        if (p.patrol > 0)
            navalChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.patrol')}">🚤 ${p.patrol}</span>`);
        if (p.auxiliaryVessels > 0)
            navalChips.push(`<span class="posture-stat" title="${t('components.strategicPosture.units.auxiliary')}">⚓ ${p.auxiliaryVessels}</span>`);
    ...
    attachEventListeners() {
        ...
        theaters.forEach((el) => {
            el.addEventListener('click', (e) => {
                ...
                if (e.target.closest('.posture-deduce-btn')) {
                    return;
                }
        ...
        deduceBtns.forEach((btn) => {
            btn.addEventListener('click', (e) => {
                e.stopPropagation();
                try {
                    const theaterDataStr = btn.dataset.theater;
                    if (!theaterDataStr)
                        return;
                    ...
                    const detail = { query, geoContext, autoSubmit: true };
