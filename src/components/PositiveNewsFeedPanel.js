...
export class PositiveNewsFeedPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "allItems", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "filterButtons", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "filterClickHandlers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
         ...
         */
        Object.defineProperty(this, "handleShareClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (e) => {
