...
import { COUNTER_METRICS, getCounterValue, formatCounterValue, } from '@/services/humanity-counters';
...
export class CountersPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "animFrameId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "valueElements", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "lastDesktopUpdateAt", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "desktopUpdateIntervalMs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 250
    ...
    startTicking() {
        ...
        if (this.desktopMode && document.hidden)
            return;
        this.animFrameId = requestAnimationFrame(this.tick);
    }
    stopTicking() {
