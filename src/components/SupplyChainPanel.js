...
export class SupplyChainPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "shippingData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "mineralsData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "expandedChokepoint", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "transitChart", {
            ...
            configurable: true,
            writable: true,
            value: new TransitChart()
        });
        Object.defineProperty(this, "chartObserver", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "chartMountTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        this.content.addEventListener('click', (e) => {
            ...
            const card = e.target.closest('.trade-restriction-card');
    ...
    `);
        if (this.activeTab === 'chokepoints' && this.expandedChokepoint) {
            const mountTransitChart = () => {
                const el = this.content.querySelector(`[data-chart-cp="${this.expandedChokepoint}"]`);
                if (!el)
                    return false;
            ...
            const riskClass = m.riskRating === 'critical' ? 'sc-risk-critical'
                : m.riskRating === 'high' ? 'sc-risk-high'
                    : m.riskRating === 'moderate' ? 'sc-risk-moderate'
                        : 'sc-risk-low';
            const top3 = m.topProducers.slice(0, 3).map(p => `${escapeHtml(p.country)} ${p.sharePct.toFixed(0)}%`).join(', ');
            return `<tr>
