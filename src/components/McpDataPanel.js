...
export class McpDataPanel extends Panel {
    constructor(spec) {
        ...
        Object.defineProperty(this, "lastFetchedAt", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastJsonHash", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "cachedWidgetHtml", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "visualizing", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "pendingHash", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "destroyController", {
            enumerable: true,
            configurable: true,
            writable: true,
    ...
    async autoVisualize(jsonData, startHash) {
        if (this.visualizing)
            return;
