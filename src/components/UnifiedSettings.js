...
export class UnifiedSettings {
    constructor(config) {
        ...
        Object.defineProperty(this, "activeSourceRegion", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 'all'
        });
        Object.defineProperty(this, "sourceFilter", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ''
        });
        Object.defineProperty(this, "activePanelCategory", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 'all'
        });
        Object.defineProperty(this, "panelFilter", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ''
        });
        Object.defineProperty(this, "escapeHandler", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "prefsCleanup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "draftPanelSettings", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {}
        });
        Object.defineProperty(this, "panelsJustSaved", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "savedTimeout", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    `;
        ...
        if (settingsPanel) {
            this.prefsCleanup = prefs.attach(settingsPanel);
        }
        const closeBtn = this.overlay.querySelector('.unified-settings-close');
        if (closeBtn) {
    ...
    renderPanelCategoryPills() {
        ...
        bar.innerHTML = categories.map(c => `<button class="unified-settings-region-pill${this.activePanelCategory === c.key ? ' active' : ''}" data-panel-cat="${c.key}">${escapeHtml(c.label)}</button>`).join('');
    }
    renderPanelsTab() {
    ...
    clonePanelSettings(source = this.config.getPanelSettings()) {
        const cloned = Object.fromEntries(Object.entries(source).map(([key, panel]) => [key, { ...panel }]));
    ...
    updatePanelsFooter() {
        const status = this.overlay.querySelector('#usPanelsStatus');
        const saveButton = this.overlay.querySelector('.panels-save-layout');
    ...
    renderRegionPills() {
        ...
        bar.innerHTML = regions.map(r => `<button class="unified-settings-region-pill${this.activeSourceRegion === r.key ? ' active' : ''}" data-region="${r.key}">${escapeHtml(r.label)}</button>`).join('');
    }
    renderSourcesGrid() {
