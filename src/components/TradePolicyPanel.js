...
export class TradePolicyPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "restrictionsData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "tariffsData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "flowsData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "barriersData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "comtradeData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        this.content.addEventListener('click', (e) => {
            const target = e.target.closest('.panel-tab');
            if (!target)
                return;
    ...
    renderTariffs() {
        ...
        const rows = sortedDatapoints.map(d => `<tr>
        <td>${d.year}</td>
    ...
    renderTariffSummary(latestBaseline, effectiveRate) {
        if (!latestBaseline)
            return '';
    ...
    renderRestrictionEffectiveContext(reportingCountry) {
        if (reportingCountry !== 'United States')
            return '';
        const gapSummary = this.getEffectiveTariffGapSummary();
        if (!gapSummary)
            return '';
    ...
    renderComtradeFlows() {
        ...
        const byYearDominant = new Map();
        for (const f of toDedup) {
            const key = `${f.reporterCode}:${f.cmdCode}:${f.year}`;
            const existing = byYearDominant.get(key);
            if (!existing || f.tradeValueUsd > existing.tradeValueUsd)
                byYearDominant.set(key, f);
        }
