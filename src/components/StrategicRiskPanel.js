...
import { calculateStrategicRiskOverview, getRecentAlerts, getAlertCount, } from '@/services/cross-module-integration';
import { detectConvergence } from '@/services/geo-convergence';
import { dataFreshness, getStatusColor, getStatusIcon, } from '@/services/data-freshness';
...
export class StrategicRiskPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "convergenceAlerts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "freshnessSummary", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "unsubscribeFreshness", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "usedCachedScores", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "breakingAlerts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "boundOnBreaking", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "breakingExpiryTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastRiskFingerprint", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ''
    ...
    async refresh() {
        ...
        this.overview = calculateStrategicRiskOverview(this.convergenceAlerts, postures ?? undefined, breakingScore, staleFactor);
    ...
    getScoreLevel(score) {
        if (score >= 70)
            return t('components.strategicRisk.levels.critical');
        if (score >= 50)
            return t('components.strategicRisk.levels.elevated');
        if (score >= 30)
            return t('components.strategicRisk.levels.moderate');
    ...
    formatTime(date) {
        ...
        if (minutes < 1)
            return t('components.strategicRisk.time.justNow');
        if (minutes < 60)
            return t('components.strategicRisk.time.minutesAgo', { count: String(minutes) });
        if (hours < 24)
            return t('components.strategicRisk.time.hoursAgo', { count: String(hours) });
    ...
    render() {
        ...
        try {
            ...
            const html = this.freshnessSummary.overallStatus === 'insufficient' && uptime > 60000 && !this.usedCachedScores
