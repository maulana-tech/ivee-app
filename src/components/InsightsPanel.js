...
import { parallelAnalysis } from '@/services/parallel-analysis';
...
import { getServerInsights } from '@/services/insights-loader';
import { computeISQ } from '@/utils/signal-quality';
...
export class InsightsPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "lastBriefUpdate", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "cachedBrief", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastMissedStories", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "lastConvergenceZones", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "lastFocalPoints", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "lastMilitaryFlights", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "lastClusters", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "aiFlowUnsubscribe", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "fwSelector", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "updateGeneration", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    async loadBriefFromCache() {
        if (this.cachedBrief)
            return false;
        const entry = await getPersistentCache(InsightsPanel.BRIEF_CACHE_KEY);
    ...
    extractISQInput(cluster) {
        ...
        const countryEntity = entities.find(e => e.matchType === 'alias' && idx.byId.get(e.entityId)?.type === 'country');
        return {
    ...
    selectTopStories(clusters, maxCount, focalFn, ciiFn, isFocalReadyFn) {
        const allScored = clusters.map(c => ({
            cluster: c,
            isq: computeISQ(this.extractISQInput(c), focalFn, ciiFn, isFocalReadyFn),
        }));
        const candidates = allScored.filter(({ cluster: c, isq }) => c.sourceCount >= 2 ||
            c.isAlert ||
    ...
    async updateFromServer(serverInsights, clusters, thisGeneration) {
        const totalSteps = 2;
        try {
            ...
            const isFocalReadyServer = () => (focalPointDetector.getLastSummary()?.topCountries.some(fp => fp.signalCount > 0 || fp.signalTypes.includes('active_strike')) ?? false);
            const sortedStories = [...serverInsights.topStories].sort((a, b) => {
                const isqA = computeISQ({ sourceCount: a.sourceCount, isAlert: a.isAlert, threatLevel: a.threatLevel ?? undefined, countryCode: a.countryCode, velocity: a.velocity }, focalFnServer, getCountryScore, isFocalReadyServer);
                const isqB = computeISQ({ sourceCount: b.sourceCount, isAlert: b.isAlert, threatLevel: b.threatLevel ?? undefined, countryCode: b.countryCode, velocity: b.velocity }, focalFnServer, getCountryScore, isFocalReadyServer);
    ...
    async updateFromClient(clusters, thisGeneration) {
        ...
        try {
            ...
            const isFocalReady = () => (focalPointDetector.getLastSummary()?.topCountries.some(fp => fp.signalCount > 0 || fp.signalTypes.includes('active_strike')) ?? false);
    ...
    renderInsights(items, sentiments, worldBrief) {
    ...
    renderServerInsights(insights, sentiments) {
    ...
    renderServerStories(stories, sentiments) {
    ...
    renderBreakingStories(items, sentiments) {
        const ISQ_BADGE_CLASS = {
...
Object.defineProperty(InsightsPanel, "BRIEF_COOLDOWN_MS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 120000
}); // 2 min cooldown (API has limits)
Object.defineProperty(InsightsPanel, "BRIEF_CACHE_KEY", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 'summary:world-brief'
});
