...
function resolveCommandLabel(cmd) {
...
export class SearchModal {
    constructor(container, options) {
        ...
        Object.defineProperty(this, "resultsList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "chipsContainer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "closeTimeoutId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "viewportHandler", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "commandResults", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "onCommand", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onQueryChange", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "onFlightSearch", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "currentFlightCallsign", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "flightSearchFired", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "activePanelIds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set()
        ...
        Object.defineProperty(this, "showingAllCommands", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    setOnQueryChange(callback) {
        this.onQueryChange = callback;
    }
    setOnFlightSearch(callback) {
    ...
    open() {
        ...
        if (flightIdx >= 0)
            this.sources[flightIdx] = { type: 'flight', items: [] };
    ...
    createModal() {
      ...
      `;
            ...
            const sheet = this.overlay.querySelector('.search-sheet');
    ...
    renderAllCommandsList() {
        ...
        const categoryOrder = ['navigate', 'layers', 'panels', 'view', 'actions', 'country'];
    ...
    renderFlightSearchTrigger(callsign) {
        if (!this.resultsList)
            return;
        this.resultsList.innerHTML = `
    ...
    triggerFlightSearch(callsign) {
        if (!this.onFlightSearch || !this.resultsList)
            return;
    ...
    renderChips(query) {
        ...
        this.chipsContainer.innerHTML = chips.map(c => `<button class="search-chip" data-value="${escapeHtml(c.value)}">${escapeHtml(c.label)}</button>`).join('');
