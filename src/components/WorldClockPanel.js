...
const STORAGE_KEY = 'ivee-world-clock-cities';
...
function loadSelectedCities() {
    ...
    if (home && !defaults.includes(home))
        defaults.unshift(home);
    return defaults;
}
function saveSelectedCities(ids) {
...
export class WorldClockPanel extends Panel {
    constructor() {
        ...
        Object.defineProperty(this, "selectedCities", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "homeCityId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "showingSettings", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "dragCityId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        this.tickInterval = setInterval(() => {
            if (!this.showingSettings && !this.dragging)
                this.renderClocks();
        }, 1000);
    }
    toggleSettings() {
    ...
    setupDragHandlers() {
        ...
        content.addEventListener('mousedown', (e) => {
            ...
            if (!handle)
                return;
            const row = handle.closest('.wc-row');
            if (!row)
                return;
            e.preventDefault();
            e.stopPropagation();
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            for (const row of rows) {
                if (row.dataset.cityId === this.dragCityId)
                    continue;
