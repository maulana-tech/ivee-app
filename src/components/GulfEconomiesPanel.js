...
function renderSection(title, quotes) {
    if (quotes.length === 0)
        return '';
...
export class GulfEconomiesPanel extends Panel {
    ...
    renderGulf(data) {
        ...
        const html = renderSection(t('panels.gulfIndices'), indices) +
