...
export class ForecastServiceClient {
  ...
  getForecasts(req?: any, options?: any) { return this.get('/api/forecast/v1/get-forecasts', req, options); }
  getSimulationPackage(req?: any, options?: any) { return this.get('/api/forecast/v1/get-simulation-package', req, options); }
  getSimulationOutcome(req?: any, options?: any) { return this.get('/api/forecast/v1/get-simulation-outcome', req, options); }
}
