...
async function sendConfirmationEmail(email, referralCode) {
  const referralLink = `https://ivee.app/pro?ref=${referralCode}`;
          ...
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
            ...
            <div style="padding: 40px 32px 0;">
              <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto 32px;">
                <tr>
                  <td style="width: 40px; height: 40px; vertical-align: middle;">
                    <img src="https://www.ivee.app/favico/android-chrome-192x192.png" width="40" height="40" alt="Ivee" style="border-radius: 50%; display: block;" />
                  </td>
              ...
              <div style="text-align: center; margin-bottom: 36px;">
                <a href="https://ivee.app" style="display: inline-block; background: #4ade80; color: #0a0a0a; padding: 14px 36px; text-decoration: none; font-weight: 800; font-size: 13px; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 2px;">Explore the Free Dashboard</a>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              <div style="margin-bottom: 16px;">
                ...
                <a href="https://github.com/koala73/ivee" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">GitHub</a>
                <a href="https://ivee.app/pro" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">Pro Waitlist</a>
              </div>
              <p style="font-size: 11px; color: #444; margin: 0; line-height: 1.6;">
                World Monitor \u2014 Real-time intelligence for a connected world.<br />
                <a href="https://ivee.app" style="color: #4ade80; text-decoration: none;">ivee.app</a>
              </p>
            </div>
          </div>`,
      }),
